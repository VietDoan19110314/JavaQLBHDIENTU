...
public class NhanVien {
	...
	public String toString() {
		return "NhanVien [idnhanvien=" + idnhanvien + ", tennhanvien=" + tennhanvien + ", gioitinh=" + gioitinh
				+ ", ngaysinh=" + ngaysinh + ", diachi=" + diachi + ", ngaybatdaulam=" + ngaybatdaulam + ", luongthang="
				+ luongthang + ", CuaHang=" + CuaHang + "]";
	}
