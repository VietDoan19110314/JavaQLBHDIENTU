...
public class QLCuahangDienTu {
	...
	public static List<NhanVien> createDSNhanVien() {
		...
		dsNhanVien.add(
				new NhanVien(
						...
						"Nu",
						dt5,
						"124, Phuong Ben Thanh, Quan 1, tp. Ho Chi Minh",
						 dt6,
						 11002000,
						 dsCuaHang.get(1)
						));	
	...
	// Câu 3: Sắp xếp lương tháng của nhân viên theo chiều tăng dần  
	 ...
	 // Câu 4: Xuất ra tên khách hàng và địa chỉ của khách hàng đến từ Thành phố Hồ Chí Minh
	 public static void Cau4() {
		 
		 var lsDiaChis = dsKhachHang
				 .stream()				 
				 .filter(c -> c.getDiaChi().contains("TPHCM")
						 || c.getDiaChi().contains("Ho Chi Minh"))
		 		 .collect(Collectors.toList());
		 System.out.println("Câu 4: Xuất ra tên khách hàng và địa chỉ của khách hàng đến từ Thành phố Hồ Chí Minh: ");
		 for (KhachHang lsDiaChi : lsDiaChis) {
			 System.out.println("Tên khách hàng: " + lsDiaChi.getTenKhachHang());
				System.out.println("Địa chỉ: " + lsDiaChi.getDiaChi());
			}
		 System.out.println("---------------------------------------------------------");
	 }
	// Câu 5: Xuất ra thông tin các hóa đơn được bán từ nhân viên nữ
		 public static void Cau5() {
			 
			 var lsHoaDons = dsHoaDon
					 .stream()
					 .filter(c -> c.NhanVien.getIDNhanVien() == 2
					 || c.NhanVien.getIDNhanVien() == 6 )
					 .collect(Collectors.toList());
			 
			 System.out.println("Câu 5: Xuất ra thông tin các hóa đơn được bán từ nhân viên nữ: ");
			 for (HoaDon lsHoaDon : lsHoaDons) {
				 System.out.println("Tên nhân viên nữ: " + lsHoaDon.NhanVien.getTenNhanVien());
					System.out.println("Mã hóa đơn: " + lsHoaDon.getIDHoadon());
				}
			 System.out.println("---------------------------------------------------------");
		 }
	 ...
	 public static void main(String[] args) {
		...
		// Phần bài của Đoàn Quốc Việt, mssv: 19110314
		Cau1();
		Cau2();
		Cau3();
		Cau4();
